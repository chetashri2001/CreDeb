...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull EditText email,
      @NonNull Button loginButton, @NonNull EditText password, @NonNull TextView registerButton,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView registerButton = rootView.findViewById(id);
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, email, loginButton, password,
          registerButton, textView, textView3);
    }
